...
const showRefreshTokens = async () => {
    try {
        ...
        console.log("error in getting  refresh tokens",e.message)
        return {status: "false", result: { message: e.message}}
...
module.exports = {addRefreshToken,removeRefreshToken,showRefreshTokens,findRefreshToken}